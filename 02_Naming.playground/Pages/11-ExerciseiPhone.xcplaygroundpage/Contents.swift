...
let numberOfMegabytesInGigabytes = 1024

//All values in MB
let phoneCapacity = 8 * numberOfMegabytesInGigabytes
let currentPhoneCapacity = 3 * numberOfMegabytesInGigabytes

let oneMinuteOfVideo = 150

//How many minutes of video will it take to fill the phone?
let result = (phoneCapacity - currentPhoneCapacity) / oneMinuteOfVideo
