...
"a".utf8CString.count % 2
"ab".utf8CString.count % 2
"abc".utf8CString.count % 2
"abcd".utf8CString.count % 2
...
func responseTo(question: String) -> String {
    ...
    if lowerQuestion == "where are the cookies?" {
        ...
        let defaultNumber = question.utf8CString.count % 2
