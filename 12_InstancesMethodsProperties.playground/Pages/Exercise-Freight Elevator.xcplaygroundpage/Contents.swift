...
let chain = TreehousePulley(weightCapacity: ricketyRope.weightCapacity * 10)

ricketyRope.canHandleAdditionalLoad(2001)

chain.canHandleAdditionalLoad(second)
chain.canHandleAdditionalLoad(third)
/*:
 - callout(Exercise):
