 ...
 */
func distanationVoteCounter(_ : [ClassTripDestination]) -> String {
    ...
    if beachVotes > chocolateFactoryVotes {
        return "On the beach!"
    } else if beachVotes < chocolateFactoryVotes {
        return "On the Chocolate Factory!"
    } else {
        return "Hmm... Lets vote again"
    }
}

distanationVoteCounter(tripDestinationVotes)
 ...
 */
func mascotVoteCounter(_ : [SchoolMascotOption]) -> String {
    ...
    if salamanderVotes > marmotVotes && salamanderVotes > neitherVotes  {
        ...
        return "Marmot!"
    } else if neitherVotes > salamanderVotes && neitherVotes > marmotVotes {
        return "Neither!"
    } else {
        return "No one"
    }
