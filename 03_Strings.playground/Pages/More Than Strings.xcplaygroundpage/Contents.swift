...
let name = "Oleg"
let number = 1000
let ajactive = "beautiful"
let noun = "go"
let place = "Odessa"
let positiveEmotion = "joy"
let negativeEmotion = "sadness"

let text = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(ajactive) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun)!"
