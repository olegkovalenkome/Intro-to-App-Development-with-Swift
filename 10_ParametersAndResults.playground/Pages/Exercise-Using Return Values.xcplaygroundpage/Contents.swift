...
let impossibleBeliefsCountResult: Int = impossibleBeliefsCount(pigsFlying: 1, frogsBecomingPrinces: 2, multipleLightningStrikes: 3)
impossibleThingsPhrase(numberOfImpossibleThings: impossibleBeliefsCountResult, meal: "banana")
